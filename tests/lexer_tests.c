...
void test_lex_numbers(void) {
  ...
  TEST_ASSERT_EQUAL_STRING("1", StringGetCstr(&tokens[0].string));
  TEST_ASSERT_EQUAL(C_INTEGER_LITERAL, tokens[0].type);
  TEST_ASSERT_EQUAL_STRING("12", StringGetCstr(&tokens[1].string));
  TEST_ASSERT_EQUAL(C_INTEGER_LITERAL, tokens[1].type);
  TEST_ASSERT_EQUAL_STRING("123", StringGetCstr(&tokens[2].string));
...
void test_default_main(void) {
  ...
  TEST_ASSERT_EQUAL_STRING("main", StringGetCstr(&tokens[1].string));
  ...
  TEST_ASSERT_EQUAL_STRING("0", StringGetCstr(&tokens[6].string));
